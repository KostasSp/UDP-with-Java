...
public class SnWclient {

       private String IPAddress;

       int port;

       // set a probability of loss during packet sending
       public static double packetLossRate = 0.05;

       // Sliding window size for stop-and-wait
       public static int windowSizeSnW = 1;
       ...
       // client constructor
       public SnWclient(String IPAdr, int port) {
       ...
       public static void main(String[] args) throws Exception {
              ...
              SnWclient client = new SnWclient("localhost", 9876);
              ...
              while (SN < file.length() + 1) {
                      ...
                      * not the final SN
                      */
                     while (SN - waitingForAck < windowSizeSnW && SN < finalPacketSN) {
                            ...
                            byte[] byteDataToServer = SnWclient.serialize(PacketObject);
                     ...
                     try {
                            ...
                            Ack ackObject = (Ack) SnWclient.deSerialize(ackPacket.getData());
                            ...
                            for (int i = waitingForAck; i < SN; i++) {
                                   ...
                                   // Serializing the Packet object
                                   byte[] byteDataToServer = SnWclient.serialize(sentPackets.get(i));
